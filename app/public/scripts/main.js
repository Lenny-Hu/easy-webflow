 ...
 * @LastEditTime: 2019-09-20 14:39:55
...
console.log(Symbol('some description'))

const s = new Set()
const arr2 = [2, 3, 5, 4, 5, 2, 2]
arr2.forEach(x => s.add(x))
...
console.log('链判断运算符', firstName, fooValue)
